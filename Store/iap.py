"""The Big Hand: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.pocketbeings.pro"
NAME = "The Big Hand"
PRICE = "2.99"
DESCRIPTION = "Four new meddles, a faster hand, name your town."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free; the town, all seven characters, the newspaper, "
    "the away summary and the five original actions (Give 50, Rob, Jail, Crown, Exile) are free forever. "
    "The Big Hand adds four more actions (Pardon, Frame, Deputise, Rain 20), a 2 second cooldown instead "
    "of 5, and renaming the town. To see the paywall: on the title screen tap the underlined link "
    "'The Big Hand: meddle harder' under NEW TOWN; or start a town, tap any character and tap one of the "
    "four locked actions; or tap the locked RENAME at the bottom of the town window. Restore is the "
    "RESTORE button on the paywall window."
)
